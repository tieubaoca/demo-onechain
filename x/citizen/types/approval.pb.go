...
func (*Approval) Descriptor() ([]byte, []int) {
	return fileDescriptor_adf55d68e1419b46, []int{0}
}
...
func (m *Approval) GetCitizenId() string {
	if m != nil {
		return m.CitizenId
	}
	return ""
...
func (m *Approval) GetOperator() string {
	if m != nil {
		return m.Operator
	}
	return ""
...
func init() {
	proto.RegisterType((*Approval)(nil), "demoonechain.citizen.Approval")
}

func init() { proto.RegisterFile("citizen/approval.proto", fileDescriptor_adf55d68e1419b46) }

var fileDescriptor_adf55d68e1419b46 = []byte{
	// 157 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *Approval) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Operator) > 0 {
		...
		i = encodeVarintApproval(dAtA, i, uint64(len(m.Operator)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.CitizenId) > 0 {
		...
		i = encodeVarintApproval(dAtA, i, uint64(len(m.CitizenId)))
		i--
		dAtA[i] = 0xa
	}
