...
func New(
	...
	app.DemoonechainKeeper = *demoonechainmodulekeeper.NewKeeper(
		appCodec,
		keys[demoonechainmoduletypes.StoreKey],
		keys[demoonechainmoduletypes.MemStoreKey],
		app.GetSubspace(demoonechainmoduletypes.ModuleName),
	)
